...
<%
System.out.println("ID="); // разобраться
...
<p class="form_auth_block_head_text">Подтвердите информацию о ЧП, чтобы назначить отряд ВП</p>
...
<br><div  class="rounded-input"><a href="http://localhost:8080/ISVP/send_VP.jsp?id=<%=id%>">Подтвердить</a></div><br>
<form action=http://localhost:8080/ISVP/nach.jsp>
